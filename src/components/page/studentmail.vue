    ...
    el-card
        .clearfix(slot="header")
            el-row(:gutter="1")
                ...
                el-col(:span="2")
                    el-button( @click="handleCreate" size="small" icon="el-icon-plus" type="primary" style="float:right") 学生通知
                el-col(:span="2")
...
export default {
  ...
  return {
    ...
    getData() {
        ...
        post('/apis/api/admin/mail/student',param).then(response => {
    ...
    async create(formName) {
        const set = this.$refs
            ...
            if (valid) {
                post('/apis/api/admin/sendMail/student', this.form)
                        .then(() => {
        ...
        handleDeletes() {
            ...
            "提示",
            {
                ...
                _delete('/apis/api/admin/mail/deletes/1')
                .then(() => {
                    this.getData()
                    this.$notify({
                        title: "成功",
